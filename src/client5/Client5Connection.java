...
/**
 * Created by dell 2 on 20-Nov-15.
 */


public class Client5Connection implements Runnable {
    ...
    public Client5Connection(Socket client, int a, int[] b, ArrayList<String> k)
    {
